...
@Composable
fun BPJSDua(navController: NavController) {
    ...
    Column(
        ...
        Row(modifier = Modifier.padding(top = 20.dp, bottom = 5.dp)) {
            Image(
                modifier = Modifier
                    .size(30.dp)
                    .clickable { navController.navigate("bpjs1")
                    },
        ...
        Card(
            ...
            Image(
                modifier = Modifier
                    ...
                    .padding(top = 15.dp),
                painter = rememberImagePainter(R.drawable.alur_prem_bpjs2),
                contentDescription = ""
            )
        ...
        androidx.compose.material3.Text(
            "Upload foto KTP asli, bukan hasil fotocopy",
                        ...
                        OutlinedCard(modifier = Modifier.shadow(2.dp, shape = RoundedCornerShape(10)) .align(Alignment.Center)) {
                            Column(
                                ...
                                Row(
                                    ...
                                    Image(
                                        painter = painterResource(id = R.drawable.ktp1),
                                        contentDescription = "Red Square",
                                        modifier = Modifier.size(250.dp)
                                    )
                                    Image(
                                        painter = painterResource(id = R.drawable.ktp2),
                                ...
                                Row(modifier = Modifier.fillMaxWidth(),
                                    ...
                                    androidx.compose.material3.Text(
                                        "Pastikan upload foto KTP asli, bukan hasil fotocopy",
                                        fontFamily = fontRegular,
                                        fontSize = 12.sp,
                                        color = Color.Black,
                                        modifier = Modifier
                                ...
                                Row(modifier = Modifier.fillMaxWidth(),
                                    ...
                                    androidx.compose.material3.Text(
                                        "Pastikan KTP terlihat jelas dalam bingkai foto",
                                        fontFamily = fontRegular,
                                        fontSize = 12.sp,
                                        color = Color.Black,
                                        modifier = Modifier
...
fun Context.createImageFile2(): File {
    ...
    val image2 = File.createTempFile(
        imageFileName,
        ".jpg",
        externalCacheDir
    )
...
//@Composable
//fun ImageCaptureCameraPreview() {
//    // Panggil fungsi ImageCaptureCamera di sini
//    ImageCaptureCamera()
//}
