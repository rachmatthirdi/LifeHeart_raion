...
@Composable
fun BPJSSatu(navController: NavController) {
    ...
    Column(
        ...
        Card(
            ...
            Image(
                modifier = Modifier
                    ...
                    .padding(top = 15.dp),
                painter = rememberImagePainter(R.drawable.alur_prem_bpjs1),
                contentDescription = ""
            )
        ...
        androidx.compose.material3.Text(
            "Pastikan KTP tidak menutupi wajah dan dapat terbaca dengan jelas",
